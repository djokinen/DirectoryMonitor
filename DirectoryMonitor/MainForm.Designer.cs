namespace DirectoryMonitor
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.columnMonitor = new System.Windows.Forms.DataGridViewCheckBoxColumn();
			...
			this.button1.Text = "Select Directory to Monitor...";
			...
			this.label1.Text = "Default Directories";
			// 
			// dataGridView
			// 
			...
			this.dataGridView.Size = new System.Drawing.Size(312, 150);
			...
			// columnMonitor
			// 
			this.columnMonitor.HeaderText = "Monitor";
			this.columnMonitor.Name = "columnMonitor";
			this.columnMonitor.ReadOnly = true;
			// 
			// MainForm
			// 
		...
		private System.Windows.Forms.DataGridViewCheckBoxColumn columnMonitor;
	}
}